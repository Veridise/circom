...
use crate::bucket_interpreter::result_types::into_single_result_u32;
...
impl<'d> MappedToIndexedPass<'d> {
    ...
    fn transform_mapped_loc_to_indexed_loc(
        ...
        let resolved_addr = interpreter
            ...
            .and_then(|v| into_single_result_u32(v, "subcomponent address"))?;
        ...
        let offset = if indexes.len() > 0 {
            ...
            for i in indexes {
                let val = interpreter
                    ...
                    .and_then(|v| into_single_result_u32(v, "subcomponent mapped signal"))?;
