...
//CHECK-SAME:  [[$F_ID_3:[0-9a-zA-Z_\.]+]]([0 x i256]* %lvars, [0 x i256]* %signals,
...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_3]]([0 x i256]* %lvars, [0 x i256]* %signals, i256* %[[T03]], i256* %[[T06]])
...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_3]]([0 x i256]* %lvars, [0 x i256]* %signals, i256* %[[T09]], i256* %[[T12]])
...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_3]]([0 x i256]* %lvars, [0 x i256]* %signals, i256* %[[T15]], i256* %[[T18]])
...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_3]]([0 x i256]* %lvars, [0 x i256]* %signals, i256* %[[T21]], i256* %[[T24]])
//CHECK-NEXT:   br label %store2
//CHECK-EMPTY: 
//CHECK-NEXT: store2:
...
//CHECK-NEXT:   %[[C04:[0-9a-zA-Z_\.]+]] = call i256 @fr_add(i256 %[[T27]], i256 1)
//CHECK-NEXT:   store i256 %[[C04]], i256* %[[T25]], align 4
//CHECK-NEXT:   br label %return3
//CHECK-EMPTY: 
//CHECK-NEXT: return3:
//CHECK-NEXT:   ret void
...
//CHECK-NEXT:   %[[T19:[0-9a-zA-Z_\.]+]] = getelementptr i256, i256* %var_[[X3]], i32 0
//CHECK-NEXT:   %[[T20:[0-9a-zA-Z_\.]+]] = bitcast i256* %[[T19]] to [0 x i256]*
//CHECK-NEXT:   %[[T21:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T20]], i32 0, i256 0
//CHECK-NEXT:   %[[T22:[0-9a-zA-Z_\.]+]] = getelementptr i256, i256* %var_[[X4]], i32 0
//CHECK-NEXT:   %[[T23:[0-9a-zA-Z_\.]+]] = bitcast i256* %[[T22]] to [0 x i256]*
//CHECK-NEXT:   %[[T24:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T23]], i32 0, i256 0
...
//CHECK-NEXT: }
//
//CHECK-LABEL: define{{.*}} void @InnerConditional9_{{[0-9]+}}_run([0 x i256]* %0){{.*}} {
//CHECK-NEXT: prelude:
