...
//
//CHECK:      store{{[0-9]+}}:
//CHECK-NEXT:   %[[VAR1:[0-9a-zA-Z_\.]+]] = getelementptr [1 x i256], [1 x i256]* %lvars, i32 0, i32 0
//CHECK-NEXT:   store i256 4, i256* %{{.*}}[[VAR1]], align 4
//CHECK-NEXT:   br label %{{.*}}
//
//CHECK:      store{{[0-9]+}}:
//CHECK-NEXT:   %[[VAR2:[0-9a-zA-Z_\.]+]] = getelementptr [1 x i256], [1 x i256]* %lvars, i32 0, i32 0
//CHECK-NEXT:   store i256 7, i256* %{{.*}}[[VAR2]], align 4
//CHECK-NEXT:   br label %{{.*}}
//
//CHECK:      store{{[0-9]+}}:
//CHECK-NEXT:   %[[VAR3:[0-9a-zA-Z_\.]+]] = getelementptr [1 x i256], [1 x i256]* %lvars, i32 0, i32 0
