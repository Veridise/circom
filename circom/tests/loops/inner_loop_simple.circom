...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_2]]([0 x i256]* %[[T15]], [0 x i256]* %0, i256* %[[T16]])
...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_2]]([0 x i256]* %[[T17]], [0 x i256]* %0, i256* %[[T18]])
...
//CHECK-NEXT:   call void @..generated..loop.body.[[$F_ID_2]]([0 x i256]* %[[T19]], [0 x i256]* %0, i256* %[[T20]])
