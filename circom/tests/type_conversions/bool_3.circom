...
//CHECK: branch{{[0-9]+}}:
//CHECK: %[[VAL_PTR:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i32 1
//CHECK: %[[VAL:[0-9a-zA-Z_\.]+]] = load i256, i256* %[[VAL_PTR]]
//CHECK: %[[BOOL:[0-9a-zA-Z_\.]+]] = icmp ne i256 %[[VAL]], 0
