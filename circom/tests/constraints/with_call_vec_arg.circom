...
//CHECK-EMPTY: 
//CHECK-NEXT: call1:
//CHECK-NEXT:   %feeShiftTable_[[$F_ID_2:[0-9a-zA-Z_\.]+]]_arena = alloca [3 x i256], align 8
//CHECK-NEXT:   %[[T00:[0-9a-zA-Z_\.]+]] = getelementptr [3 x i256], [3 x i256]* %feeShiftTable_[[$F_ID_2]]_arena, i32 0, i32 0
...
//CHECK-NEXT:   %[[T02:[0-9a-zA-Z_\.]+]] = getelementptr [3 x i256], [3 x i256]* %feeShiftTable_[[$F_ID_2]]_arena, i32 0, i32 2
...
//CHECK-NEXT:   %[[T05:[0-9a-zA-Z_\.]+]] = bitcast [3 x i256]* %feeShiftTable_[[$F_ID_2]]_arena to i256*
//CHECK-NEXT:   %[[C2:[0-9a-zA-Z_\.]+]] = call i256 @feeShiftTable_[[$F_ID_2]](i256* %[[T05]])
//CHECK-NEXT:   %[[T06:[0-9a-zA-Z_\.]+]] = getelementptr i256, i256* %sig_0, i32 0
//CHECK-NEXT:   store i256 %[[C2]], i256* %[[T06]], align 4
//CHECK-NEXT:   %[[T07:[0-9a-zA-Z_\.]+]] = load i256, i256* %[[T06]], align 4
//CHECK-NEXT:   %constraint = alloca i1, align 1
//CHECK-NEXT:   call void @__constraint_values(i256 %[[C2]], i256 %[[T07]], i1* %constraint)
...
//CHECK-NEXT: }
//
//CHECK-LABEL: define{{.*}} i256 @feeShiftTable_
//CHECK-SAME: [[$F_ID_2]](i256* %0){{.*}} {
//CHECK-NEXT: feeShiftTable_[[$F_ID_2]]:
