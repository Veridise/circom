...
//CHECK-NEXT:   %[[T02:[0-9]+]] = getelementptr i256, i256* %sig_0, i32 0
...
//CHECK-NEXT:   %[[T05:[0-9]+]] = getelementptr i256, i256* %sig_0, i32 0
...
//CHECK-NEXT:   %[[T09:[0-9]+]] = getelementptr i256, i256* %sig_0, i32 1
