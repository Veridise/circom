...
//CHECK-SAME: [[$F_ID_1:[0-9]+\.F]]([0 x i256]* %lvars, [0 x i256]* %signals, i256* %subfix_0, [0 x i256]* %sub_0, i256* %subc_0){{.*}} {
...
//CHECK-NEXT:   %2 = getelementptr i256, i256* %subfix_0, i32 0
...
//CHECK-NEXT:   %6 = getelementptr i256, i256* %subfix_0, i32 0
...
//CHECK-NEXT:   %10 = getelementptr i256, i256* %subfix_0, i32 1
