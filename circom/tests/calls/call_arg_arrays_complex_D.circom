...
//CHECK-NEXT:   %[[T97:[0-9a-zA-Z_\.]+]] = call i1 @fr_lt(i256 %[[T02]], i256 7)
//CHECK-NEXT:   br i1 %[[T97]], label %if.then, label %if.else
//CHECK-EMPTY:
//CHECK-NEXT: if.then:
...
//CHECK-NEXT:   %[[T98:[0-9a-zA-Z_\.]+]] = call i1 @fr_gt(i256 %[[T05]], i256 12)
//CHECK-NEXT:   br i1 %[[T98]], label %if.then1, label %if.else2
//CHECK-EMPTY:
//CHECK-NEXT: if.merge:
...
//CHECK-EMPTY:
//CHECK-NEXT: call1:
//CHECK-NEXT:   %[[CALL_ARENA:[0-9a-zA-Z_\.]+]] = alloca [19 x i256], align 8
//CHECK-NEXT:   %[[T01:[0-9a-zA-Z_\.]+]] = getelementptr [19 x i256], [19 x i256]* %[[CALL_ARENA]], i32 0, i32 0
...
//CHECK-NEXT:   %[[DST_PTR:[0-9a-zA-Z_\.]+]] = getelementptr [19 x i256], [19 x i256]* %[[CALL_ARENA]], i32 0, i32 1
...
//CHECK-NEXT:   %[[DST_PTR:[0-9a-zA-Z_\.]+]] = getelementptr [19 x i256], [19 x i256]* %[[CALL_ARENA]], i32 0, i32 7
...
//CHECK-NEXT:   %[[DST_PTR:[0-9a-zA-Z_\.]+]] = getelementptr [19 x i256], [19 x i256]* %[[CALL_ARENA]], i32 0, i32 13
...
//CHECK-NEXT:   %[[T10:[0-9a-zA-Z_\.]+]] = bitcast [19 x i256]* %[[CALL_ARENA]] to i256*
//CHECK-NEXT:   %[[SRC_PTR:[0-9a-zA-Z_\.]+]] = call i256* @sum_[[$F_ID_1]](i256* %[[T10]])
