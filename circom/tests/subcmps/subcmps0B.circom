...
//CHECK-EMPTY: 
//CHECK-NEXT: store3:
//CHECK-NEXT:   %[[T04:[0-9a-zA-Z_\.]+]] = getelementptr [3 x i256], [3 x i256]* %lvars, i32 0, i32 1
//CHECK-NEXT:   store i256 0, i256* %[[T04]], align 4
//CHECK-NEXT:   br label %store4
//CHECK-EMPTY: 
//CHECK-NEXT: store4:
//CHECK-NEXT:   %[[T05:[0-9a-zA-Z_\.]+]] = getelementptr [3 x i256], [3 x i256]* %lvars, i32 0, i32 2
...
//CHECK-NEXT:   %[[T13:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 0, i32 0
...
//CHECK-NEXT:   %[[T16:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T15]], i32 0, i256 0
//CHECK-NEXT:   %[[T17:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 0, i32 0
...
//CHECK-NEXT:   %[[T20:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T19]], i32 0, i256 0
//CHECK-NEXT:   %[[T21:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 0, i32 0
...
//CHECK-NEXT:   %[[T24:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 0, i32 1
...
//CHECK-NEXT:   %[[T26:[0-9a-zA-Z_\.]+]] = bitcast [3 x i256]* %lvars to [0 x i256]*
//CHECK-NEXT:   %[[T27:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 0
//CHECK-NEXT:   %[[T28:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T27]], align 8
//CHECK-NEXT:   %[[T29:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T28]], i32 0
//CHECK-NEXT:   %[[T30:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T29]], i32 0, i256 1
//CHECK-NEXT:   %[[T31:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i256 3
//CHECK-NEXT:   %[[T32:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i256 1
//CHECK-NEXT:   %[[T33:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 0
...
//CHECK-NEXT:   %[[T36:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T35]], i32 0, i256 0
//CHECK-NEXT:   %[[T37:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 0
//CHECK-NEXT:   %[[T38:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T37]], align 8
//CHECK-NEXT:   %[[T39:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T38]], i32 0
//CHECK-NEXT:   %[[T40:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T39]], i32 0, i256 0
//CHECK-NEXT:   %[[T41:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 0
//CHECK-NEXT:   %[[T42:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T41]], align 8
//CHECK-NEXT:   %[[T43:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T42]], i32 0
//CHECK-NEXT:   %[[T44:[0-9a-zA-Z_\.]+]] = getelementptr [2 x { [0 x i256]*, i32 }], [2 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 1
//CHECK-NEXT:   %[[T45:[0-9a-zA-Z_\.]+]] = bitcast i32* %[[T44]] to i256*
