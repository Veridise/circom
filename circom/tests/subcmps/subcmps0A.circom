...
//CHECK-NEXT:   %[[T099:[0-9a-zA-Z_\.]+]] = call i256 @fr_add(i256 %[[T009]], i256 1)
//CHECK-NEXT:   store i256 %[[T099]], i256* %[[T010]], align 4
...
//CHECK-NEXT:   %[[T099:[0-9a-zA-Z_\.]+]] = call i256 @fr_neg(i256 %[[T002]])
//CHECK-NEXT:   store i256 %[[T099]], i256* %[[T003]], align 4
