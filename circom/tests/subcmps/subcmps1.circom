...
//CHECK-NEXT:   %[[T999:[0-9a-zA-Z_\.]+]] = call i256 @fr_add(i256 %[[T011]], i256 1)
//CHECK-NEXT:   store i256 %[[T999]], i256* %[[T012]], align 4
...
//CHECK-NEXT:   %[[T14:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 0, i32 0
//CHECK-NEXT:   %[[T15:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T14]], align 8
//CHECK-NEXT:   %[[T16:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T15]], i32 0
//CHECK-NEXT:   %[[T17:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T16]], i32 0, i256 0
...
//CHECK-NEXT:   %[[T21:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 0, i32 1
//CHECK-NEXT:   %[[T22:[0-9a-zA-Z_\.]+]] = bitcast i32* %[[T21]] to i256*
...
//CHECK-NEXT:   %[[T28:[0-9a-zA-Z_\.]+]] = bitcast [2 x i256]* %lvars to [0 x i256]*
//CHECK-NEXT:   %[[T29:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 0
//CHECK-NEXT:   %[[T30:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T29]], align 8
//CHECK-NEXT:   %[[T31:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T30]], i32 0
//CHECK-NEXT:   %[[T32:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T31]], i32 0, i256 1
//CHECK-NEXT:   %[[T33:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i256 4
//CHECK-NEXT:   %[[T34:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i256 1
//CHECK-NEXT:   %[[T35:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 0
...
//CHECK-NEXT:   %[[T38:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T37]], i32 0, i256 0
...
//CHECK-NEXT:   %[[T42:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 1, i32 1
//CHECK-NEXT:   %[[T43:[0-9a-zA-Z_\.]+]] = bitcast i32* %[[T42]] to i256*
...
//CHECK-NEXT:   %[[T49:[0-9a-zA-Z_\.]+]] = bitcast [2 x i256]* %lvars to [0 x i256]*
//CHECK-NEXT:   %[[T50:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 2, i32 0
//CHECK-NEXT:   %[[T51:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T50]], align 8
//CHECK-NEXT:   %[[T52:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T51]], i32 0
//CHECK-NEXT:   %[[T53:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T52]], i32 0, i256 1
//CHECK-NEXT:   %[[T54:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i256 5
//CHECK-NEXT:   %[[T55:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %0, i32 0, i256 2
//CHECK-NEXT:   %[[T56:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 2, i32 0
//CHECK-NEXT:   %[[T57:[0-9a-zA-Z_\.]+]] = load [0 x i256]*, [0 x i256]** %[[T56]], align 8
//CHECK-NEXT:   %[[T58:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T57]], i32 0
//CHECK-NEXT:   %[[T59:[0-9a-zA-Z_\.]+]] = getelementptr [0 x i256], [0 x i256]* %[[T58]], i32 0, i256 0
...
//CHECK-NEXT:   %[[T63:[0-9a-zA-Z_\.]+]] = getelementptr [3 x { [0 x i256]*, i32 }], [3 x { [0 x i256]*, i32 }]* %subcmps, i32 0, i32 2, i32 1
//CHECK-NEXT:   %[[T64:[0-9a-zA-Z_\.]+]] = bitcast i32* %[[T63]] to i256*
