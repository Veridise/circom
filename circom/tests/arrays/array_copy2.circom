...
//CHECK-NEXT: %[[INP_PTR_0:[0-9]+]] = getelementptr [6 x i256], [6 x i256]* %lvars, i32 0, i32 0
...
//CHECK-NEXT: %[[INP_PTR_1:[0-9]+]] = getelementptr [6 x i256], [6 x i256]* %lvars, i32 0, i32 1
...
//CHECK-NEXT: %[[INP_PTR_2:[0-9]+]] = getelementptr [6 x i256], [6 x i256]* %lvars, i32 0, i32 2
...
//CHECK-NEXT: %[[INP_PTR_3:[0-9]+]] = getelementptr [6 x i256], [6 x i256]* %lvars, i32 0, i32 3
...
//CHECK-NEXT: %[[INP_PTR_4:[0-9]+]] = getelementptr [6 x i256], [6 x i256]* %lvars, i32 0, i32 4
