...
use code_producers::llvm_elements::{
    build_fn_name, LLVMInstruction, LLVMIRProducer, run_fn_name, to_basic_metadata_enum, to_enum,
};
...
pub struct CreateCmpBucket {
    ...
    // index of component's template
    pub template_id: usize,
    // unique id of component
    pub cmp_unique_id: usize,
    // "<name of template>_<instantiation number>"
    pub symbol: String,
    // index of component's instance
    pub sub_cmp_id: InstructionPointer,
    // name of component's instance (e.g. "a" in "a = A()")
